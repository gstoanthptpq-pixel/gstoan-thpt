...
# ==============================================================================
# 3. TRÌNH TẠO HÌNH ẢNH VECTOR (CHỐNG LỖI HIỂN THỊ BẰNG BASE64)
# ==============================================================================
...
def get_math_data(lesson_name):
    ...
    return {
        "svg": "DON_DIEU",
        "cd1_t": f"Định nghĩa, tính chất và các định lý cốt lõi của chuyên đề {lesson_title} bám sát Vở tự học Kết nối tri thức.",
        ...
        "cd2_t": f"Phương pháp phân tích bài toán và các bước biến đổi trung gian của {lesson_title}.",
